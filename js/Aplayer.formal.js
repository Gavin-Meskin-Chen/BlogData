...
// 							default.isMobile && this.container.classList.add("aplayer-mobile"), this.arrow = this.container.offsetWidth <= 300, this.arrow && this.container.classList.add("aplayer-arrow"), this.container = this.options.container, 2 === this.options.lrcType || !0 === this.options.lrcType)
...
// 								default.pause), this.timer.enable("loading"), this.options.mutex)
...
// 							default.volumeUp : this.volume() > 0 ? this.template.volumeButton.innerHTML = o.
// 							default.volumeDown : this.template.volumeButton.innerHTML = o.
// 							default.volumeOff
// 						}
// 					}, {
// 						key: "volume",
